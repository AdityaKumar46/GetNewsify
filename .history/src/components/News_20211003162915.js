...
const News = (props) => {
    ...
    handlePrevClick = async () => {
        ...
        /**  let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=3415a559da894aa390a66455e0c4112b&page=${this.state.page - 1}&pageSize=${props.pageSize}`
             this.setState({loading: true})
             let data = await fetch(url);
             let parsedData=await data.json();
        ...
        return (
            <>
                <div className="text-center my-4">
                    <h1>GetNewify - Top {this.upperCaseFirst(props.category)} Headlines </h1>
